...
I prefer small issues with a clear problem statement and a practical way to
validate the fix. I want to improve at navigating unfamiliar codebases,
reading existing tests, and making focused changes. I want to avoid broad
refactors, undocumented environment dependencies, and issues without a
testable result.
`